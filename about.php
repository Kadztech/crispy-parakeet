...
<html lang="en">
    ...
    <body>
        ...
        <!-- Home Start -->
        <section style="padding-bottom: 24px;" class="bg-half-170 d-table w-100 bg-light" style="background: url('images/bg/page.png') top center;" id="home">
            <div class="container">
                <div class="row mt-5">
                    <div class="col-lg-12">
                        <div class="title-heading text-center text-md-left">
                            ...
                            <p class="text-muted para-desc mt-3 mb-0">
                                We exist to transform your business for growth and impact through digital services and accurate analytics.
                            </p> 
                            <p class="text-muted para-desc mt-3 mb-0">
                                We measure our success by the long-lasting impact we deliver for our clients. This philosophy has helped us build a strong reputation for adding business value.
                            </p> 

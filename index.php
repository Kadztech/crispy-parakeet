...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Kadztech software services - Landing page</title>
...
<header id="topnav" class="defaultscroll sticky">
            <div class="container">
                ...
                <div class="buy-button">
                    <a href="./about.php" class="text-dark h6 mr-3 login">About us</a>
                    <a href="mailto:careers@kadztech.com" class="btn btn-primary">We're Hiring</a>
                    ...
                    <div class="col-12">
                        <div class="title-heading text-center">
                            <h4 class="heading text-white mb-3">
                                We're Kadztech Software services
                            </h4>
                            <p class="text-white-50 para-desc mx-auto mb-0">Lets transform your business for growth and impact through digital services together and accurate analytics.</p>
                        
                            <div class="mt-4">
                                <a href="javascript:void(0)" class="btn btn-primary mx-1">Get Started</a>
                                <a href="./about.php" class="btn btn-light mx-1">Learn More</a>
                            </div>
                        </div>
                    </div><!--end col-->
                </div><!--end row-->
                ...
                <div class="row justify-content-center">
                    <div class="col-12">
                        <div class="section-title text-center mb-4 pb-2">
                            <h4 class="title mb-3">Our Services to you 😊</h4>
                            <p class="text-muted para-desc mx-auto mb-0">Experience exponential growth and turn your ideas into incredible products and efficient services with Kadztech software services.</p>
                        </div>
                    </div><!--end col-->
                </div><!--end row-->
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6 col-12 mt-4 pt-2">
                        <div class="card services p-4 rounded-pill border-0">
                            ...
                            <div class="card-body p-0 content">
                                <h5 class="mb-3"><a href="hosting-shared.html" class="title text-dark">Mobile & Web apps</a></h5>
                                <p class="text-muted mb-3">We provide Cross-platform mobile app development
                                    Application modernization
                                    Digital marketplaces Content
                    ...
                    <div class="col-lg-4 col-md-6 col-12 mt-4 pt-2">
                        <div class="card services p-4 rounded-pill border-0">
                            ...
                            <div class="card-body p-0 content">
                                <h5 class="mb-3"><a href="hosting-vps.html" class="title text-dark">Data & Analytics</a></h5>
                                <p class="text-muted mb-3">Data Management
                                    Data Virtualization Data
                                    Governance Data Migration
                                    Visualization tools
                                    Telemetry and application monitoring tools</p>
                    ...
                    <div class="col-lg-4 col-md-6 col-12 mt-4 pt-2">
                        <div class="card services p-4 rounded-pill border-0">
                            ...
                            <div class="card-body p-0 content">
                                <h5 class="mb-3"><a href="hosting-dedicated.html" class="title text-dark">Graphics Designing</a></h5>
                                <p class="text-muted mb-3">Logo and Branding
                    ...
                    <div class="col-lg-4 col-md-6 col-12 mt-4 pt-2">
                        <div class="card services p-4 rounded-pill border-0">
                            ...
                            <div class="card-body p-0 content">
                                <h5 class="mb-3"><a href="hosting-cloud.html" class="title text-dark">Cloud & Software Engineering</a></h5>
                                <p class="text-muted mb-3">Containerization
                                    Cloud Adoption
                    ...
                    <div class="col-lg-4 col-md-6 col-12 mt-4 pt-2">
                        <div class="card services p-4 rounded-pill border-0">
                            ...
                            <div class="card-body p-0 content">
                                <h5 class="mb-3"><a href="hosting-domain.html" class="title text-dark">E-commerce Intergration</a></h5>
                                <p class="text-muted mb-3">e Commerce integration services for companies looking to join the electronic payment initiative and offer twenty-four hour availability to their customers. </p>
                    ...
                    <div class="col-lg-7 mt-4">
                        <div id="customer-testi" class="owl-carousel owl-theme">
                            ...
                            <div class="card border-0 text-center client-bar m-2">
                                ...
                                <img src="images/client/04.jpg" class="avatar avatar-md-md mt-4 testi-img rounded-circle shadow mx-auto" alt="">
                                <h6 class="text-primary mt-2 mb-0">Thomas Israel</h6>
                                <small class="text-muted">C.E.O</small>
                            </div>
                            ...
                            <div class="card border-0 text-center client-bar m-2">
                                ...
                                <img src="images/client/05.jpg" class="avatar avatar-md-md mt-4 testi-img rounded-circle shadow mx-auto" alt="">
                                <h6 class="text-primary mt-2 mb-0">Thomas Israel</h6>
                                <small class="text-muted">C.E.O</small>
                            </div>
                            ...
                            <div class="card border-0 text-center client-bar m-2">
                                ...
                                <img src="images/client/06.jpg" class="avatar avatar-md-md mt-4 testi-img rounded-circle shadow mx-auto" alt="">
                                <h6 class="text-primary mt-2 mb-0">Thomas Israel</h6>
                                <small class="text-muted">C.E.O</small>
                            </div>
                        </div>
